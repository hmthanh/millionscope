...
//                                 dynamicMetaImports = [],
//                                 isFollowingSymlink
//                             }: CollectFilesOptions): Promise<{ imports: Import[] | undefined; pageMap: Awaited<undefined | { route: any; children: []; name: string } | { route: any; name: string; frontMatter: { [p: string]: any } } | { data: string }>[]; dynamicMetaImports: DynamicImport[] | undefined; hasDynamicPage: boolean }> {
