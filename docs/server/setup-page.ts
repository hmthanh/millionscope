...
// import { DynamicFolder, DynamicMeta, DynamicMetaDescriptor, DynamicMetaItem, DynamicMetaJsonFile, Folder, NextraInternalGlobal, PageMapItem, PageOpts, ThemeConfig } from "@/global/types";
//
...
// }
//
// export function collectCatchAllRoutes(parent: Folder<any>, meta: DynamicMetaJsonFile, isRootFolder = true): void {
//   if (isRootFolder) {
