...
import type { mathJaxOptionsSchema, nextraConfigSchema, searchSchema } from "@/server/schemas";
...
export type Nextra = (nextraConfig: NextraConfig) => (nextConfig: NextConfig) => NextConfig;
