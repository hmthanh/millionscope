...
// import { useActiveAnchor, useConfig, useMenu, useThemeConfig } from "@/contexts";
...
//       ? active || activeRouteInside || focusedRouteInside || (theme && "collapsed" in theme ? !theme.collapsed : level < config.sidebar.defaultMenuCollapseLevel)
...
// }
//
// export function Sidebar({ docsDirectories, flatDirectories, fullDirectories, asPopover = false, headings, includePlaceholder }: SideBarProps): ReactElement {
//   const config = useConfig();
...
//   return (
//     <>
//       {includePlaceholder && asPopover ? <div className="max-xl:nx-hidden nx-h-0 nx-w-64 nx-shrink-0" /> : null}
//       <div
...
//               "nx-mx-4 nx-py-4 nx-shadow-[0nx--12pxnx-16pxnx-#fff]",
//               "nx-flex nx-items-center nx-gap-2",
//               "dark:nx-border-neutral-800 dark:nx-shadow-[0nx--12pxnx-16pxnx-#111]",
...
//           >
//             <LocaleSwitch lite={!showSidebar} className={cn(showSidebar ? "nx-grow" : "max-md:nx-grow")} />
//             {config.darkMode && (
