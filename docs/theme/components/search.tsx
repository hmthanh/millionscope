...
export function Search({ className, overlayClassName, value, onChange, onActive, loading, error, results }: SearchProps): ReactElement {
    ...
    >
      <kbd
        className={cn(
          ...
          "nx-border dark:nx-border-gray-100/20 dark:nx-bg-black/50",
          "contrast-more:nx-border-current contrast-more:nx-text-current contrast-more:dark:nx-border-current",
          "nx-items-center nx-gap-1 nx-transition-opacity nx-flex",
          value ? "nx-z-20 nx-cursor-pointer hover:nx-opacity-70" : "nx-pointer-events-none max-sm:nx-hidden",
        )}
  ...
  return (
    <div className={cn("nextra-search nx-relative md:nx-w-64", className)}>
      ...
      >
        <ul
          className={cn("nextra-search-results nextra-scrollbar", overlayClassName)}
          ref={ulRef}
          style={{
        ...
        >
          {error ? (
            <span className="nx-flex nx-select-none nx-justify-center nx-gap-2 nx-p-8 nx-text-center nx-text-sm nx-text-red-500">
              <InformationCircleIcon className="nx-size-5" />
            ...
            <span className="nx-flex nx-select-none nx-justify-center nx-gap-2 nx-p-8 nx-text-center nx-text-sm nx-text-gray-400">
              <SpinnerIcon className="nx-size-5 nx-animate-spin" />
