...
export function Head(): ReactElement {
  ...
  // const { primaryHue: hue, primarySaturation: saturation } = themeConfig;
  ...
  // const frontMatter = themeConfig.frontMatter as NextSeoProps;

  return (
    <>
      {/*<NextSeo title={themeConfig.title} description={frontMatter.description} canonical={frontMatter.canonical} openGraph={frontMatter.openGraph} {...themeConfig.useNextSeoProps?.()} />*/}
      <NextHead>
