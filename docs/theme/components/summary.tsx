...
export function Summary({ children, ...props }: ComponentProps<"summary">): ReactElement {
  return (
    <summary className="nx-flex nx-items-center nx-cursor-pointer nx-p-1 nx-transition-colors hover:nx-bg-gray-100 dark:hover:nx-bg-neutral-800" {...props}>
      {children}
      <ArrowRightIcon
        className={cn(
