 ...
 */
export function MDXRemote<TScope, TFrontmatter>({ compiledSource, frontmatter, scope, components = {}, lazy }: MDXRemoteProps<TScope, TFrontmatter>) {
  ...
  // markdown banner.tsx (such as "h1" or "a") with the "banner.tsx" object
  const content = (
