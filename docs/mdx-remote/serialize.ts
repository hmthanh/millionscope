...
function getCompileOptions(mdxOptions: SerializeOptions["mdxOptions"] = {}, rsc: boolean = false): CompileOptions {
 ...
 */
export async function serialize<TScope = Record<string, unknown>, TFrontmatter = Record<string, unknown>>(
