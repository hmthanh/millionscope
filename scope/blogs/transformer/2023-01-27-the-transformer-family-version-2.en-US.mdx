...
![](./img/the-transformer-family-v2/multi-head-attention.png)
...
![](./img/the-transformer-family-v2/transformer.png)
...
![](./img/the-transformer-family-v2/sinoidual-positional-encoding.png)
...
![](./img/the-transformer-family-v2/RoPE.png)
...
![](./img/the-transformer-family-v2/transformer-XL-training.png)
...
![](./img/the-transformer-family-v2/compressive-transformer.png)
...
![](./img/the-transformer-family-v2/compressive-transformer-memory.png)
...
![](./img/the-transformer-family-v2/SPALM2.png)
...
![](./img/the-transformer-family-v2/memorizing-transformer.png)
...
![](./img/the-transformer-family-v2/ALiBi-bias.png)
...
![](./img/the-transformer-family-v2/ALiBi-exp.png)
...
![](./img/the-transformer-family-v2/universal-transformer-loop.png)
...
![](./img/the-transformer-family-v2/universal-transformer.png)
...
![](./img/the-transformer-family-v2/attention-per-head.png)
...
![](./img/the-transformer-family-v2/soft-masking-function.png)
...
![](./img/the-transformer-family-v2/depth-adaptive-classifier.png)
...
![](./img/the-transformer-family-v2/image-transformer-attention.png)
...
![](./img/the-transformer-family-v2/sparse-attention.png)
...
![](./img/the-transformer-family-v2/combined-attention.png)
...
![](./img/the-transformer-family-v2/LSH-attention-matrix.png)
...
![](./img/the-transformer-family-v2/LSH-attention.png)
...
![](./img/the-transformer-family-v2/linformer.png)
...
![](./img/the-transformer-family-v2/RFA.png)
...
![](./img/the-transformer-family-v2/performer.png)
...
![](./img/the-transformer-family-v2/gated-transformer-XL.png)
