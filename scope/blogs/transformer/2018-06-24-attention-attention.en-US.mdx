...
![shiba](./img/transformer/shiba-example-attention.png)
...
![sentence](./img/transformer/sentence-example-attention.png)
...
![encoder-decoder model with additive attention layer](./img/transformer/encoder-decoder-example.png)
...
![encoder-decoder model with additive attention layer](./img/transformer/encoder-decoder-attention.png)
...
![alignment matrix](./img/transformer/bahdanau-fig3.png)
...
![intra-attention](./img/transformer/cheng2016-fig1.png)
...
![show-attend-and-tell](./img/transformer/xu2015-fig6b.png)
...
![global-local-attention](./img/transformer/luong2015-fig2-3.png)
...
![turing-machine](./img/transformer/turing-machine.jpg)
...
![turing-machine](./img/transformer/NTM.png)
...
![shift-weighting](./img/transformer/shift-weighting.png)
...
![NTM-flow-addressing](./img/transformer/NTM-flow-addressing.png)
...
![pointer network](./img/transformer/ptr-net.png)
...
![Transformer encoder](./img/transformer/transformer-encoder.png)
...
![Transformer decoder](./img/transformer/transformer-decoder.png)
...
![Transformer model](./img/transformer/transformer.png)
...
![SNAIL](./img/transformer/snail.png)
...
![Conv vs self-attention on images](./img/transformer/conv-vs-self-attention.png)
...
![SAGAN](./img/transformer/SAGAN.png)
...
![SAGAN examples](./img/transformer/SAGAN-examples.png)
