...
![](./img/self-supervised/self-sup-lecun.png)
...
![examplar-cnn](./img/self-supervised/examplar-cnn.png)
...
![self-sup-rotation](./img/self-supervised/self-sup-rotation.png)
...
![self-sup-by-relative-position](./img/self-supervised/self-sup-by-relative-position.png)
...
![chromatic-aberration](./img/self-supervised/chromatic-aberration.png)
...
![self-sup-jigsaw-puzzle](./img/self-supervised/self-sup-jigsaw-puzzle.png)
...
![](./img/self-supervised/self-sup-counting-features.png)
...
![](./img/self-supervised/context-encoder.png)
...
![](./img/self-supervised/split-brain-autoencoder.png)
...
![](./img/self-supervised/bi-GAN.png)
...
![](./img/self-supervised/CPC-audio.png)
...
![](./img/self-supervised/CPC-image.png)
...
![](./img/self-supervised/tracking-videos.png)
...
![](./img/self-supervised/frame-order-validation.png)
...
![](./img/self-supervised/learning-arrow-of-time.png)
...
![](./img/self-supervised/video-colorization.png)
...
![](./img/self-supervised/video-colorization-examples.png)
...
![](./img/self-supervised/grasp2vec.png)
...
![](./img/self-supervised/grasp2vec-attention-map.png)
...
![](./img/self-supervised/RIG-algorithm.png)
...
![](./img/self-supervised/CC-RIG.png)
...
![](./img/self-supervised/CC-RIG-goal-samples.png)
...
![](./img/self-supervised/DeepMDP.png)
...
![](./img/self-supervised/DBC-illustration.png)
...
![](./img/self-supervised/DBC-algorithm.png)
