...
![](./img/overview/data_size_vs_model_performance.png)
...
![](./img/overview/visual_cortex_system.png)
...
![](./img/overview/RNN.png)
Fig. 5. A recurrent neural network with one hidden unit (left) and its unrolling version in time (right). The unrolling version illustrates what happens in time:
$s_{t-1}$, $s_{t}$, and $s_{t+1}$ are the same unit with different states at different time steps $t-1$, $t$, and $t+1$. (Image source: [LeCun, Bengio, and Hinton, 2015](http://pages.cs.wisc.edu/~dyer/cs540/handouts/deep-learning-nature2015.pdf); [Fig. 5](https://www.nature.com/nature/journal/v521/n7553/fig_tab/nature14539_F5.html))
...
![](./img/overview/rnn_shakespeare.png)
...
![](./img/overview/seq2seq_gmail.png)
...
![](./img/overview/autoencoder_experiment.png)
...
![](./img/overview/alphago_paper.png) ![](./img/overview/alphago_model.png)
...
![](./img/overview/deep_learning_toolkits.png)
