...
export default class BodyBlog extends Component {
    render() {
        return (
            <div className="nx-mx-auto nx-flex nx-max-w-[90rem]">
                ...
                <article className="nx-w-full nx-break-words nextra-content nx-flex nx-min-h-[calc(100vh-var(--nextra-navbar-height))] nx-min-w-0 nx-justify-center nx-pb-8 nx-pr-[calc(env(safe-area-inset-right)-1.5rem)]">
                    <main className="nx-w-full nx-min-w-0 nx-max-w-6xl nx-px-6 nx-pt-4 md:nx-px-12">
                        ...
                        <p className="nx-mt-6 nx-leading-7 first:nx-mt-0">For normal RESTful APIs with JSON data, first you need to create a
                            ...
                            <code className="nx-border-black nx-border-opacity-[0.04] nx-bg-opacity-[0.03] nx-bg-black nx-break-words nx-rounded-md nx-border nx-py-0.5 nx-px-[.25em] nx-text-[.9em] dark:nx-border-white/10 dark:nx-bg-white/10  " dir="ltr">fetcher

                            </code> function, which is just a wrapper of the native
                            ...
                            <code className="nx-border-black nx-border-opacity-[0.04] nx-bg-opacity-[0.03] nx-bg-black nx-break-words nx-rounded-md nx-border nx-py-0.5 nx-px-[.25em] nx-text-[.9em] dark:nx-border-white/10 dark:nx-bg-white/10  " dir="ltr">fetch
                        ...
                        <p className="nx-mt-6 nx-leading-7 first:nx-mt-0">Then you can import
                            ...
                            <code className="nx-border-black nx-border-opacity-[0.04] nx-bg-opacity-[0.03] nx-bg-black nx-break-words nx-rounded-md nx-border nx-py-0.5 nx-px-[.25em] nx-text-[.9em] dark:nx-border-white/10 dark:nx-bg-white/10  " dir="ltr">useSWR

                            </code> and start using it inside any function components:</p>
                        ...
                        <p className="nx-mt-6 nx-leading-7 first:nx-mt-0">In a real-world example, our website shows a navbar and the content, both depend on
                            ...
                            <code className="nx-border-black nx-border-opacity-[0.04] nx-bg-opacity-[0.03] nx-bg-black nx-break-words nx-rounded-md nx-border nx-py-0.5 nx-px-[.25em] nx-text-[.9em] dark:nx-border-white/10 dark:nx-bg-white/10  " dir="ltr">user
                        ...
                        <p className="nx-mt-6 nx-leading-7 first:nx-mt-0">Traditionally, we fetch data once using
                            ...
                            <code className="nx-border-black nx-border-opacity-[0.04] nx-bg-opacity-[0.03] nx-bg-black nx-break-words nx-rounded-md nx-border nx-py-0.5 nx-px-[.25em] nx-text-[.9em] dark:nx-border-white/10 dark:nx-bg-white/10  " dir="ltr">useEffect

                            </code> in the top level component, and pass it to child components via props (notice that we dont handle error state for now):</p>
                        ...
                        <p className="nx-mt-6 nx-leading-7 first:nx-mt-0">SWR solves the problem perfectly. With the
                            ...
                            <code className="nx-border-black nx-border-opacity-[0.04] nx-bg-opacity-[0.03] nx-bg-black nx-break-words nx-rounded-md nx-border nx-py-0.5 nx-px-[.25em] nx-text-[.9em] dark:nx-border-white/10 dark:nx-bg-white/10  " dir="ltr">useUser

                            </code> hook we just created, the code can be refactored to:</p>
