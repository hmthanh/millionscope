...
// import { DiscordIcon, GitHubIcon } from '@scope/icons'
...
import type { NavBarProps } from '@scope/components/navbar'
import { themeOptionsSchema, ThemeSwitch } from '@scope/components/theme-switch'
import type { TOCProps } from '@scope/components/toc'
...
//       // )
//       return <MatchSorterSearch className={className} directories={directories} />
//     },
//     emptyResult: (
