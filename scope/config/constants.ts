...
import type { NavBarProps } from '@scopeui/components/navbar'
import { themeOptionsSchema, ThemeSwitch } from '@scopeui/components/theme-switch'
import type { TOCProps } from '@scopeui/components/toc'
